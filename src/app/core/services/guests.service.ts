...
export class GuestsService {
  private guests = [
    ...
    { weddingId: 1, id: 9, name: "Carlos", category: "Rugby", allergies: "Sin alergias", table: null },
    { weddingId: 1, id: 10, name: "Luis", category: "Rugby", allergies: "Sin alergias", table: null },
    { weddingId: 1, id: 11, name: "David", category: "Rugby",  allergies: "Sin alergias", table: null },
    { weddingId: 1, id: 12, name: "Rayul", category: "Rugby",  allergies: "Marisco", table: null },
    { weddingId: 1, id: 13, name: "Santiago", category: "Escuela",  allergies: "Marisco", table: null },
    { weddingId: 1, id: 14, name: "Sergio", category: "Rugby",  allergies: "Marisco", table: null },
    { weddingId: 1, id: 15, name: "Javier", category: "Rugby", allergies: "Sin alergias", table: null },
    { weddingId: 1, id: 16, name: "Redu", category: "Rugby", allergies: "Pescado", table: null },
